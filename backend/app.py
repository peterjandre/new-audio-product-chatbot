...
# Import from scripts package - lazy import to avoid import-time failures
# RAGEngine will be imported when needed in _initialize_rag_engine()
...
def _initialize_rag_engine():
    ...
    try:
        # Lazy import of RAGEngine to avoid import-time failures
...
async def lifespan(app: FastAPI):
    ...
    if _temp_dir:
        ...
        try:
            ...
            print(f"Error cleaning up temp dir: {e}", file=sys.stderr, flush=True)
